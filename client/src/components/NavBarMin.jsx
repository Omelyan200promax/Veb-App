        ...
        >
          <Link to = {HomeRoute} >  <Heading className = 'heading' ml={'5px'}>Bookworm</Heading></Link>
            ...
            <Flex width ={'12%'}   justify={'space-around'}>
                <Link to= {AuthRoute}><svg width="40" height="40" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg width="41" height="41" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg xmlns="http://www.w3.org/2000/svg"  width="23" height="23" viewBox="0 0 15 15" >
